...
// --- Data Simulation for Level 25 ---

const generateLevel25Members = () => {
  const members = [];
  // Loop from Member ID 24002 up to and including 25001
  for (let i = 24002; i <= 25001; i++) {
...
export default function MemberSystemLevel25Page() {
  const level25Members = React.useMemo(() => generateLevel25Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 25 Members Database (24,002-25,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 25. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 25 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 25 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
