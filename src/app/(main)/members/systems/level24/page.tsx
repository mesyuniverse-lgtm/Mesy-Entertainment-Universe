...
// --- Data Simulation for Level 24 ---

const generateLevel24Members = () => {
  const members = [];
  // Loop from Member ID 25002 up to and including 26001
  for (let i = 25002; i <= 26001; i++) {
...
export default function MemberSystemLevel24Page() {
  const level24Members = React.useMemo(() => generateLevel24Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 24 Members Database (25,002-26,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 24. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 24 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 24 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
