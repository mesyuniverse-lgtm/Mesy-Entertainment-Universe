...
export default function MemberSystemLevel4Page() {
  const level4Members = React.useMemo(() => generateLevel4Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 4 Members Database (4,000-4,999 Members)
              </CardTitle>
              <CardDescription>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 4 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 4 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
