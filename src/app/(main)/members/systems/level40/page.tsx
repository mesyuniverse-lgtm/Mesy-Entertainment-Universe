...
// --- Data Simulation for Level 40 ---

const generateLevel40Members = () => {
  const members = [];
  // Loop from Member ID 9002 up to and including 10001
  for (let i = 9002; i <= 10001; i++) {
...
export default function MemberSystemLevel40Page() {
  const level40Members = React.useMemo(() => generateLevel40Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 40 Members Database (9,002-10,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 40. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 40 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 40 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
