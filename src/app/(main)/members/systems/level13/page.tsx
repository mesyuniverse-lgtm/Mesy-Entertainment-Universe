...
// --- Data Simulation for Level 13 ---

const generateLevel13Members = () => {
  const members = [];
  // Loop from Member ID 36002 up to and including 37001
  for (let i = 36002; i <= 37001; i++) {
...
export default function MemberSystemLevel13Page() {
  const level13Members = React.useMemo(() => generateLevel13Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 13 Members Database (36,002-37,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 13. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 13 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 13 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
