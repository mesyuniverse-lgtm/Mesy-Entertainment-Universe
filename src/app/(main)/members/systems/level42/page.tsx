...
// --- Data Simulation for Level 42 ---

const generateLevel42Members = () => {
  const members = [];
  // Loop from Member ID 7002 up to and including 8001
  for (let i = 7002; i <= 8001; i++) {
...
export default function MemberSystemLevel42Page() {
  const level42Members = React.useMemo(() => generateLevel42Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 42 Members Database (7,002-8,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 42. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 42 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 42 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
