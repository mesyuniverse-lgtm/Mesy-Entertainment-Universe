...
// --- Data Simulation for Level 15 ---

const generateLevel15Members = () => {
  const members = [];
  // Loop from Member ID 34002 up to and including 35001
  for (let i = 34002; i <= 35001; i++) {
...
export default function MemberSystemLevel15Page() {
  const level15Members = React.useMemo(() => generateLevel15Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 15 Members Database (34,002-35,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 15. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 15 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 15 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
