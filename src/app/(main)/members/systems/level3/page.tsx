...
export default function MemberSystemLevel3Page() {
  const level3Members = React.useMemo(() => generateLevel3Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 3 Members Database (46,002-47,001)
              </CardTitle>
              <CardDescription>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 3 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 3 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
