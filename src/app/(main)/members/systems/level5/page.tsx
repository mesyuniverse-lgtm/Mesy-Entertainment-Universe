...
// --- Data Simulation for Level 5 ---

const generateLevel5Members = () => {
  const members = [];
  for (let i = 5000; i <= 5999; i++) {
    const downlines = 5000 + (i - 5000); // Downline grows from 5000
...
export default function MemberSystemLevel5Page() {
  const level5Members = React.useMemo(() => generateLevel5Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 5 Members Database (5,000-5,999)
              </CardTitle>
              <CardDescription>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 5 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 5 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
