...
// --- Data Simulation for Level 2 ---

const generateLevel2Members = () => {
  const members = [];
  for (let i = 2000; i <= 2999; i++) {
    const downlines = 2000 + (i - 2000); // Downline grows from 2000
...
export default function MemberSystemLevel2Page() {
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 2 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 2 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
