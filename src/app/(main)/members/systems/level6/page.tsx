...
// --- Data Simulation for Level 6 ---

const generateLevel6Members = () => {
  const members = [];
  for (let i = 6000; i <= 6999; i++) {
    const downlines = 6000 + (i - 6000); // Downline grows from 6000
...
export default function MemberSystemLevel6Page() {
  const level6Members = React.useMemo(() => generateLevel6Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 6 Members Database (6,000-6,999)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 6. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 6 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 6 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
