...
// --- Data Simulation for Level 28 ---

const generateLevel28Members = () => {
  const members = [];
  // Loop from Member ID 21002 up to and including 22001
  for (let i = 21002; i <= 22001; i++) {
...
export default function MemberSystemLevel28Page() {
  const level28Members = React.useMemo(() => generateLevel28Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 28 Members Database (21,002-22,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 28. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 28 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 28 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
