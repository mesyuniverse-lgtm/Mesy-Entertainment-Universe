...
// --- Data Simulation for Level 32 ---

const generateLevel32Members = () => {
  const members = [];
  // Loop from Member ID 17002 up to and including 18001
  for (let i = 17002; i <= 18001; i++) {
...
export default function MemberSystemLevel32Page() {
  const level32Members = React.useMemo(() => generateLevel32Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 32 Members Database (17,002-18,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 32. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 32 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 32 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
