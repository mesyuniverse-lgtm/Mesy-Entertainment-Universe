...
// --- Data Simulation for Level 39 ---

const generateLevel39Members = () => {
  const members = [];
  // Loop from Member ID 10002 up to and including 11001
  for (let i = 10002; i <= 11001; i++) {
...
export default function MemberSystemLevel39Page() {
  const level39Members = React.useMemo(() => generateLevel39Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 39 Members Database (10,002-11,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 39. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 39 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 39 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
