...
// --- Data Simulation for Level 30 ---

const generateLevel30Members = () => {
  const members = [];
  // Loop from Member ID 19002 up to and including 20001
  for (let i = 19002; i <= 20001; i++) {
...
export default function MemberSystemLevel30Page() {
  const level30Members = React.useMemo(() => generateLevel30Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 30 Members Database (19,002-20,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 30. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 30 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 30 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
