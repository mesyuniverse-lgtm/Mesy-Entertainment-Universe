...
// --- Data Simulation for Level 31 ---

const generateLevel31Members = () => {
  const members = [];
  // Loop from Member ID 18002 up to and including 19001
  for (let i = 18002; i <= 19001; i++) {
...
export default function MemberSystemLevel31Page() {
  const level31Members = React.useMemo(() => generateLevel31Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 31 Members Database (18,002-19,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 31. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 31 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 31 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
