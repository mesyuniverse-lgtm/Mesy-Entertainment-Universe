...
// --- Data Simulation for Level 11 ---

const generateLevel11Members = () => {
  const members = [];
  // Loop from Member ID 38002 up to and including 39001
  for (let i = 38002; i <= 39001; i++) {
...
export default function MemberSystemLevel11Page() {
  const level11Members = React.useMemo(() => generateLevel11Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 11 Members Database (38,002-39,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 11. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 11 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 11 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
