...
export default function MemberSystemLevel33Page() {
  const level33Members = React.useMemo(() => generateLevel33Members(), []);
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 33 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 33 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
