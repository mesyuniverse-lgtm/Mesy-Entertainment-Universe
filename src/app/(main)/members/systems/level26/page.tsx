...
// --- Data Simulation for Level 26 ---

const generateLevel26Members = () => {
  const members = [];
  // Loop from Member ID 23002 up to and including 24001
  for (let i = 23002; i <= 24001; i++) {
...
export default function MemberSystemLevel26Page() {
  const level26Members = React.useMemo(() => generateLevel26Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 26 Members Database (23,002-24,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 26. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 26 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 26 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
