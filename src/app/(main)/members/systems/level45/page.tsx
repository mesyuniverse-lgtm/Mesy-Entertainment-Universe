...
// --- Data Simulation for Level 45 ---

const generateLevel45Members = () => {
  const members = [];
  // Loop from Member ID 4002 up to and including 5001
  for (let i = 4002; i <= 5001; i++) {
...
export default function MemberSystemLevel45Page() {
  const level45Members = React.useMemo(() => generateLevel45Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 45 Members Database (4,002-5,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 45. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 45 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 45 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
