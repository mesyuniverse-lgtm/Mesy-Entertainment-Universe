...
// --- Data Simulation for Level 36 ---

const generateLevel36Members = () => {
  const members = [];
  // Loop from Member ID 13002 up to and including 14001
  for (let i = 13002; i <= 14001; i++) {
...
export default function MemberSystemLevel36Page() {
  const level36Members = React.useMemo(() => generateLevel36Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 36 Members Database (13,002-14,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 36. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 36 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 36 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
