...
// --- Data Simulation for Level 38 ---

const generateLevel38Members = () => {
  const members = [];
  // Loop from Member ID 11002 up to and including 12001
  for (let i = 11002; i <= 12001; i++) {
...
export default function MemberSystemLevel38Page() {
  const level38Members = React.useMemo(() => generateLevel38Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 38 Members Database (11,002-12,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 38. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 38 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 38 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
