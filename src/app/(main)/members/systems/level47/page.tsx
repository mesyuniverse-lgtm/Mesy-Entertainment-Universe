...
// --- Data Simulation for Level 47 ---

const generateLevel47Members = () => {
  const members = [];
  // Loop from Member ID 2002 up to and including 3001
  for (let i = 2002; i <= 3001; i++) {
...
export default function MemberSystemLevel47Page() {
  const level47Members = React.useMemo(() => generateLevel47Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 47 Members Database (2,002-3,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 47. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 47 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 47 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
