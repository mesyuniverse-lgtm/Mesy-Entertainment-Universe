...
// --- Data Simulation for Level 48 ---

const generateLevel48Members = () => {
  const members = [];
  // Loop from Member ID 1002 up to and including 2001
  for (let i = 1002; i <= 2001; i++) {
...
export default function MemberSystemLevel48Page() {
  const level48Members = React.useMemo(() => generateLevel48Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 48 Members Database (1,002-2,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 48. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 48 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 48 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
