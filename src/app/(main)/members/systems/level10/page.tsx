...
// --- Data Simulation for Level 10 ---

const generateLevel10Members = () => {
  const members = [];
  // Loop from Member ID 39002 up to and including 40001
  for (let i = 39002; i <= 40001; i++) {
...
export default function MemberSystemLevel10Page() {
  const level10Members = React.useMemo(() => generateLevel10Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 10 Members Database (39,002-40,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 10. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 10 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 10 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
