...
// --- Data Simulation for Level 46 ---

const generateLevel46Members = () => {
  const members = [];
  // Loop from Member ID 3002 up to and including 4001
  for (let i = 3002; i <= 4001; i++) {
...
export default function MemberSystemLevel46Page() {
  const level46Members = React.useMemo(() => generateLevel46Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 46 Members Database (3,002-4,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 46. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 46 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 46 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
