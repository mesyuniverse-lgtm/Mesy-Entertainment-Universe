...
// --- Data Simulation for Level 18 ---

const generateLevel18Members = () => {
  const members = [];
  // Loop from Member ID 31002 up to and including 32001
  for (let i = 31002; i <= 32001; i++) {
...
export default function MemberSystemLevel18Page() {
  const level18Members = React.useMemo(() => generateLevel18Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 18 Members Database (31,002-32,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 18. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 18 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 18 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
