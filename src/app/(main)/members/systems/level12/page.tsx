...
// --- Data Simulation for Level 12 ---

const generateLevel12Members = () => {
  const members = [];
  // Loop from Member ID 37002 up to and including 38001
  for (let i = 37002; i <= 38001; i++) {
...
export default function MemberSystemLevel12Page() {
  const level12Members = React.useMemo(() => generateLevel12Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 12 Members Database (37,002-38,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 12. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 12 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 12 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
