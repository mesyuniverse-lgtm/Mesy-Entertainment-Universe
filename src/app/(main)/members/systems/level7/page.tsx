...
// --- Data Simulation for Level 7 ---

const generateLevel7Members = () => {
  const members = [];
  for (let i = 7000; i <= 7999; i++) {
    const downlines = 7000 + (i - 7000); // Downline grows from 7000
...
export default function MemberSystemLevel7Page() {
  const level7Members = React.useMemo(() => generateLevel7Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 7 Members Database (7,000-7,999)
              </CardTitle>
              <CardDescription>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 7 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 7 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
