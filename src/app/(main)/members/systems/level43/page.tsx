...
// --- Data Simulation for Level 43 ---

const generateLevel43Members = () => {
  const members = [];
  // Loop from Member ID 6002 up to and including 7001
  for (let i = 6002; i <= 7001; i++) {
...
export default function MemberSystemLevel43Page() {
  const level43Members = React.useMemo(() => generateLevel43Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 43 Members Database (6,002-7,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 43. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 43 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 43 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
