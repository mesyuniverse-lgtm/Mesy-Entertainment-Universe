...
// --- Data Simulation for Level 20 ---

const generateLevel20Members = () => {
  const members = [];
  // Loop from Member ID 29002 up to and including 30001
  for (let i = 29002; i <= 30001; i++) {
...
export default function MemberSystemLevel20Page() {
  const level20Members = React.useMemo(() => generateLevel20Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 20 Members Database (29,002-30,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 20. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 20 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 20 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
