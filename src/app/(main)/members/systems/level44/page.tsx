...
// --- Data Simulation for Level 44 ---

const generateLevel44Members = () => {
  const members = [];
  // Loop from Member ID 5002 up to and including 6001
  for (let i = 5002; i <= 6001; i++) {
...
export default function MemberSystemLevel44Page() {
  const level44Members = React.useMemo(() => generateLevel44Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 44 Members Database (5,002-6,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 44. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 44 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 44 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
