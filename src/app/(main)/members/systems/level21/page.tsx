...
// --- Data Simulation for Level 21 ---

const generateLevel21Members = () => {
  const members = [];
  // Loop from Member ID 28002 up to and including 29001
  for (let i = 28002; i <= 29001; i++) {
...
export default function MemberSystemLevel21Page() {
  const level21Members = React.useMemo(() => generateLevel21Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 21 Members Database (28,002-29,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 21. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 21 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 21 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
