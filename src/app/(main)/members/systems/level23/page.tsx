...
// --- Data Simulation for Level 23 ---

const generateLevel23Members = () => {
  const members = [];
  // Loop from Member ID 26002 up to and including 27001
  for (let i = 26002; i <= 27001; i++) {
...
export default function MemberSystemLevel23Page() {
  const level23Members = React.useMemo(() => generateLevel23Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 23 Members Database (26,002-27,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 23. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 23 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 23 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
