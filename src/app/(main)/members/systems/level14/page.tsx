...
export default function MemberSystemLevel14Page() {
  const level14Members = React.useMemo(() => generateLevel14Members(), []);
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 14 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 14 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
