...
// --- Data Simulation for Level 8 ---

const generateLevel8Members = () => {
  const members = [];
  for (let i = 8000; i <= 8999; i++) {
    const downlines = 8000 + (i - 8000); // Downline grows from 8000
...
export default function MemberSystemLevel8Page() {
  const level8Members = React.useMemo(() => generateLevel8Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 8 Members Database (8,000-8,999)
              </CardTitle>
              <CardDescription>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 8 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 8 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
