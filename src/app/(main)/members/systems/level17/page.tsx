...
// --- Data Simulation for Level 17 ---

const generateLevel17Members = () => {
  const members = [];
  // Loop from Member ID 32002 up to and including 33001
  for (let i = 32002; i <= 33001; i++) {
...
export default function MemberSystemLevel17Page() {
  const level17Members = React.useMemo(() => generateLevel17Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 17 Members Database (32,002-33,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 17. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 17 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 17 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
