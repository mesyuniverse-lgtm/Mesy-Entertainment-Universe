...
// --- Data Simulation for Level 41 ---

const generateLevel41Members = () => {
  const members = [];
  // Loop from Member ID 8002 up to and including 9001
  for (let i = 8002; i <= 9001; i++) {
...
export default function MemberSystemLevel41Page() {
  const level41Members = React.useMemo(() => generateLevel41Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 41 Members Database (8,002-9,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 41. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 41 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 41 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
