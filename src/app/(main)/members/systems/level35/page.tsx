...
// --- Data Simulation for Level 35 ---

const generateLevel35Members = () => {
  const members = [];
  // Loop from Member ID 14002 up to and including 15001
  for (let i = 14002; i <= 15001; i++) {
...
export default function MemberSystemLevel35Page() {
  const level35Members = React.useMemo(() => generateLevel35Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 35 Members Database (14,002-15,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 35. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 35 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 35 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
