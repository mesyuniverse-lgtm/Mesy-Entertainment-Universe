...
// --- Data Simulation for Level 37 ---

const generateLevel37Members = () => {
  const members = [];
  // Loop from Member ID 12002 up to and including 13001
  for (let i = 12002; i <= 13001; i++) {
...
export default function MemberSystemLevel37Page() {
  const level37Members = React.useMemo(() => generateLevel37Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 37 Members Database (12,002-13,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 37. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 37 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 37 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
