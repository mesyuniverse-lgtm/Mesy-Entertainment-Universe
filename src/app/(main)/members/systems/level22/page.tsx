...
// --- Data Simulation for Level 22 ---

const generateLevel22Members = () => {
  const members = [];
  // Loop from Member ID 27002 up to and including 28001
  for (let i = 27002; i <= 28001; i++) {
...
export default function MemberSystemLevel22Page() {
  const level22Members = React.useMemo(() => generateLevel22Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 22 Members Database (27,002-28,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 22. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 22 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 22 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
