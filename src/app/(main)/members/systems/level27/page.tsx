...
// --- Data Simulation for Level 27 ---

const generateLevel27Members = () => {
  const members = [];
  // Loop from Member ID 22002 up to and including 23001
  for (let i = 22002; i <= 23001; i++) {
...
export default function MemberSystemLevel27Page() {
  const level27Members = React.useMemo(() => generateLevel27Members(), []);
          ...
          <div className="flex items-start justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-primary tracking-wider">
                Level 27 Members Database (22,002-23,001)
              </CardTitle>
              <CardDescription>
                This system displays all pre-defined Member ID slots for Level 27. Activate your purchased ID to claim your slot.
              </CardDescription>
            </div>
        ...
        <CardContent>
            ...
            <Card className="mb-6 bg-secondary/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter the code for your purchased Level 27 Member ID to activate your account and claim your income slot.
                    </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Level 27 Members Database</CardTitle>
              </CardHeader>
              <CardContent>
