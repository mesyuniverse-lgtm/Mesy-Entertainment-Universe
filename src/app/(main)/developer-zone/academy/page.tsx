    ...
    <div className="min-h-screen bg-background/90 text-foreground p-4 lg:p-6" style={{background: 'radial-gradient(ellipse at bottom, hsl(var(--accent)/0.1), hsl(var(--background)) 70%)'}}>
        ...
        <aside className="lg:col-span-3 hidden lg:block space-y-6">
            ...
            <Card className="bg-card/50">
                ...
                <CardContent>
                    <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10"><AvatarImage src={popularInstructors[2].avatar}/></Avatar>
                        <div>
                            <p className="font-semibold text-sm">{popularInstructors[2].name}</p>
                            <p className="text-xs text-muted-foreground">{popularInstructors[2].skill}</p>
                        </div>
            ...
            <Card className="bg-card/50">
                ...
                <CardContent>
                   <div className="space-y-3">
                       <div><p className="font-semibold text-sm">Intro to 3D Modeling for MESY</p><p className="text-xs text-muted-foreground">By: {popularInstructors[1].name}</p></div>
                       <div><p className="font-semibold text-sm">Advanced AI Agent Design</p><p className="text-xs text-muted-foreground">By: {popularInstructors[0].name}</p></div>
                   </div>
                </CardContent>
            </Card>
        </aside>
