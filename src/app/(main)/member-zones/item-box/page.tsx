...
export default function ItemBoxPage() {
    ...
    return (
        <div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><Box className="text-primary"/>Your Inventory</CardTitle>
                    <CardDescription>Items you've collected from rewards, quests, and events.</CardDescription>
                </CardHeader>
                <CardContent>
                    {items.length === 0 ? (
                         <div className="flex flex-col items-center justify-center min-h-[200px] text-center p-6 border-2 border-dashed rounded-lg">
                            ...
                            <p className="mt-4 font-semibold">Your item box is empty.</p>
