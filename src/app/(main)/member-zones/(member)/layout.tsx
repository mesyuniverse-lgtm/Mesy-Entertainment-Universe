...
const sidebarNavItems = [
  { name: 'Dashboard', href: '/member-zones/dashboard', icon: LayoutDashboard },
  { name: 'MESY Universe', href: '/member-zones/universe', icon: Orbit },
  { name: 'My Profile', href: '/member-zones/profile', icon: UserCircle },
  { name: 'Social', href: '/member-zones/groups', icon: Users },
  { name: 'Member System', href: '/member-zones/member-system', icon: Shield },
  { name: 'Daily Rewards', href: '/member-zones/daily-rewards', icon: Gift },
  { name: 'My Bag', href: '/member-zones/bag', icon: Package },
  { name: 'My Inventory', href: '/member-zones/inventory', icon: Package },
  { name: 'My Cloud', href: '/member-zones/cloud', icon: Cloud },
  { name: 'Build', href: '/member-zones/build', icon: Hammer },
  { name: 'Shop', href: '/member-zones/shop', icon: Wallet },
  { name: 'Market', href: '/member-zones/market', icon: Wallet },
  { name: 'Customize', href: '/member-zones/customize', icon: Wallet },
  { name: 'Settings', href: '/member-zones/settings', icon: Settings },
  { name: 'Admin', href: '/member-zones/admin', icon: Shield, adminOnly: true },
];
