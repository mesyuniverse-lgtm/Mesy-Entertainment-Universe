...
export default function ConnectionsDatingPage() {
  ...
  const bgImage = PlaceHolderImages.find(i => i.id === 'rose-background');
    ...
    <div className="relative min-h-screen">
        ...
        <div className="container py-12 relative z-10">
          ...
          <div className="mt-12 space-y-12">
            ...
            <Card className="overflow-hidden shadow-2xl shadow-primary/10 bg-card/50 backdrop-blur-sm">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {aiRecommendations.map((person, index) => (
                        <Card key={index} className="overflow-hidden group text-center border-border/50 hover:border-primary/50 hover:shadow-lg transition-all bg-card/50 backdrop-blur-sm">
