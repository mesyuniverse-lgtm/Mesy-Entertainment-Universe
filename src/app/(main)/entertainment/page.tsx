  ...
  const entertainmentSections = [
    {
      ...
      icon: <div className="flex gap-2"><Music className="text-primary"/><Mic className="text-primary"/></div>,
    ...
    },
    {
      ...
      icon: <div className="flex gap-2"><Map className="text-primary"/><Store className="text-primary"/></div>,
