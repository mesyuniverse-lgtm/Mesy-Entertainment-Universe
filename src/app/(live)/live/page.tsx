...
import { Search, Clapperboard, Video, UserPlus, Rss, UsersRound, CalendarClock, Crown, Gift, Users, UserCheck, Mic, Star, Send, Heart, Share2, Save, BadgeCent } from "lucide-react";
                ...
                <main className="lg:col-span-6 space-y-4">
                    ...
                    <div className="relative flex overflow-x-hidden bg-primary/10 border border-primary/30 rounded-lg py-2 text-sm">
                        <div className="animate-marquee whitespace-nowrap text-primary font-semibold">
                            ...
                            <span className="mx-4">Happy Birthday to Kael! 🎂</span>
                        </div>
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-4 z-20 text-white">
                                    <div className="flex items-end">
                                        ...
                                        <div className="flex flex-col gap-3 pl-3">
                                            ...
                                            <Button variant="ghost" size="icon" className="bg-white/10 rounded-full h-12 w-12 hover:bg-white/20"><BadgeCent className="text-green-400" /></Button>
                                            <Button variant="ghost" size="icon" className="bg-white/10 rounded-full h-12 w-12 hover:bg-white/20"><Star className="text-purple-400" /></Button>
                                            <Button variant="ghost" size="icon" className="bg-white/10 rounded-full h-12 w-12 hover:bg-white/20"><Share2 /></Button>
                                            <Button variant="ghost" size="icon" className="bg-white/10 rounded-full h-12 w-12 hover:bg-white/20"><Save /></Button>
                                        </div>
                                    </div>
                    ...
                    <Card className="bg-card/50">
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">Add magic to your stream.</p>
                            </div>
                             <div>
                                <h4 className="font-semibold text-sm">Audio Settings</h4>
                                <p className="text-xs text-muted-foreground">Adjust your microphone and sound.</p>
                            </div>
                             <div>
