...
const PayPalIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <path fill="#009cde" d="m22.66 4.34-2.1 9.06a1.27 1.27 0 0 1-1.25 1.07h-3.33c-.28 0-.54.1-.72.27L10.38 19c-.19.17-.45.27-.73.27H3.53a.62.62 0 0 1-.6-.76L5.1 4.34a1.27 1.27 0 0 1 1.25-1.07h5.59c.
28 0 .54.1.73.28l4.88 4.06c.19.17.45-.27.72.27h3.06c.7 0 1.23.63 1.13 1.23Z" />
