    ...
    return (
        <div className="container mx-auto py-12">
            <div className="text-center">
                <h1 className="text-5xl font-headline font-bold tracking-wider text-primary-foreground" style={{ textShadow: '0 0 10px hsl(var(--primary))' }}>
                    MEMBERS ZONE
                </h1>
                <p className="mt-4 text-lg text-muted-foreground">
                    สวัสดีค่ะ คุณ {user?.displayName || 'Visitor'}, ยินดีต้อนรับสู่พื้นที่สำหรับสมาชิก
                </p>
                <div className="mt-4 flex justify-center gap-6 text-sm text-muted-foreground">
                    <span className="flex items-center gap-2"><LogIn className="h-4 w-4"/> 1,234 ผู้เข้า Login</span>
                    <span className="flex items-center gap-2"><Diamond className="h-4 w-4"/> 56 ผู้สำเร็จ Quest</span>
                    <span className="flex items-center gap-2"><Users className="h-4 w-4"/> 78 ผู้รับรางวัล</span>
                </div>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="bg-card/70 backdrop-blur-sm border-white/10 text-white hover:border-primary/50 transition-all">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3"><BookOpen /> MEMBERS NEWS</CardTitle>
                        <CardDescription className="text-muted-foreground">ข้อมูลข่าวสารสมาชิก</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button variant="secondary" className="w-full">เพิ่มเติม</Button>
                    </CardContent>
                </Card>
                 <Card className="bg-card/70 backdrop-blur-sm border-white/10 text-white hover:border-primary/50 transition-all">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3"><LogIn /> MEMBERS LOGIN NOW</CardTitle>
                 ...
                 <Card className="bg-card/70 backdrop-blur-sm border-white/10 text-white hover:border-primary/50 transition-all">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-3"><UserPlus /> ลงทะเบียน MEMBER</CardTitle>
            ...
            <Card className="mt-12 bg-card/70 backdrop-blur-sm border-white/10 text-white text-center">
                <CardContent className="p-8">
                    ...
                    <Button variant="secondary">Stake Now</Button>
                </CardContent>
            </Card>
        </div>
    );
