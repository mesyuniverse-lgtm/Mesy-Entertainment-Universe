            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <div className='lg:col-span-1 xl:col-span-1 space-y-6'>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                       <StatCard icon={<Users className="h-6 w-6"/>} title="Online Users" value={stats.online.toLocaleString()} />
                       <StatCard icon={<CheckCircle className="h-6 w-6"/>} title="Quests Completed" value={stats.questSuccess.toLocaleString()} />
                       <StatCard icon={<Trophy className="h-6 w-6"/>} title="Prize Winners" value={stats.prizeWinners.toLocaleString()} />
                    </div>
                     <Card className="bg-card/70 backdrop-blur-sm border-white/10">
                         <CardHeader>
                            <CardTitle className="text-base text-primary">All Users</CardTitle>
                        </CardHeader>
