                ...
                <Card className="bg-card/50">
                    <CardContent className="p-3">
                        <div className='flex gap-3 items-center'>
                            ...
                            <Textarea placeholder="What's on your mind, User?" className="bg-muted border-0 focus-visible:ring-1 focus-visible:ring-primary flex-grow rounded-full px-4 py-2 h-10 resize-none" />
                        </div>
