    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-muted-foreground">Manage your account, profile, and security settings.</p>
            </div>
                ...
                <CardContent className="space-y-6">
                    <div className="flex items-end gap-4 p-4 border rounded-lg">
                        <div className="flex-grow space-y-2">
                            ...
                            <Input id="email" type="email" defaultValue="member@mesy.io" />
                        </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Manage your shipping and billing address for marketplace purchases.</CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-2">
                     ...
                     <div className="border-t pt-6 space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">Set a 6-digit PIN for confirming important transactions like withdrawals and high-value trades.</p>
