            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <TabsList>
                                <TabsTrigger value="video" asChild>
                                    <Link href="/social" className="flex items-center gap-2"><Video className="h-4 w-4" />Social Video</Link>
                                </TabsTrigger>
                ...
                <aside className="lg:col-span-3 space-y-6">
                    <Button size="lg" className="w-full !text-base" asChild>
                        <Link href="/member-plan"><Star className="mr-2 h-4 w-4"/> Become a Member</Link>
                    </Button>
                    <Card className="bg-card/50 border-primary/50 shadow-lg shadow-primary/10">
                     ...
                     <Card className="bg-card/50 border-dashed border-border hover:border-primary/50 transition-colors">
                        <CardContent className="p-4 h-32 flex flex-col items-center justify-center text-center">
                           ...
                           <p className="text-sm text-muted-foreground">Upload Picture / Video<br/>Add Link / URL</p>
                        </CardContent>
                    </Card>
                     <Card className="bg-card/50 border-dashed border-border hover:border-primary/50 transition-colors">
                        <CardContent className="p-4 h-32 flex flex-col items-center justify-center text-center">
